...
class StorageService {
  ...
  Future<String> uploadPaymentProof({
    ...
    final ref = _storage.ref('kametis/$kametiId/payments/$cycleId/$memberId/$name');
  ...
  Future<String> uploadProfilePhoto({required String userId, required File file}) async {
    final ref = _storage.ref('users/$userId/profile_${DateTime.now().millisecondsSinceEpoch}.jpg');
    await ref.putFile(file);
    return ref.getDownloadURL();
  }
