...
abstract class PaymentRepository {
  ...
  Future<void> submitPaymentProof(String kametiId, String cycleId,
      String paymentId, Map<String, Object?> data);
  Future<void> approvePayment(String kametiId, String cycleId, String paymentId,
      Map<String, Object?> data);
  Future<void> rejectPayment(
      String kametiId, String cycleId, String paymentId, String reason);
}

abstract class ReceiverRepository {
  Future<void> confirmReceiver(
      String kametiId, ReceiverAllocationModel allocation);
  Stream<QuerySnapshot<Map<String, dynamic>>> streamAllocations(
      String kametiId);
  Future<void> markPayoutPaid(
      String kametiId, String allocationId, Map<String, Object?> data);
}

abstract class BiddingRepository {
  Future<void> startBidding(String kametiId, Map<String, Object?> sessionData);
  Future<void> submitBid(
      String kametiId, String sessionId, Map<String, Object?> bidData);
  Future<void> updateBid(String kametiId, String sessionId, String bidId,
  ...
  Future<void> completeBidding(
      String kametiId, String sessionId, Map<String, Object?> resultData);
  Stream<DocumentSnapshot<Map<String, dynamic>>> streamBiddingSession(
      String kametiId, String sessionId);
  Stream<QuerySnapshot<Map<String, dynamic>>> streamBids(
      String kametiId, String sessionId);
}

abstract class DrawRepository {
  Future<void> saveLuckyDrawResult(
      String kametiId, Map<String, Object?> drawData);
...
abstract class LedgerRepository {
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> streamLedgerEntries(
      String kametiId);
...
abstract class ReportRepository {
  ...
  Future<void> updateReportVisibility(String kametiId, String reportId,
      ReportVisibility visibility, List<String> memberIds);
}

abstract class NotificationRepository {
  Future<void> createNotification(NotificationModel notification);
  Stream<QuerySnapshot<Map<String, dynamic>>> streamUserNotifications(
      String userId);
...
abstract class AuditLogRepository {
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> getUserSecurityLogs(
      String userId);
}
...
abstract class DisputeRepository {
  ...
  Future<void> updateDispute(
      String kametiId, String disputeId, Map<String, Object?> data);
  Future<void> addDisputeComment(DisputeCommentModel comment);
  Future<void> resolveDispute(
      String kametiId, String disputeId, Map<String, Object?> resolution);
...
abstract class TrustScoreRepository {
  ...
  Stream<DocumentSnapshot<Map<String, dynamic>>> streamTrustScore(
      String userId);
...
class FirebaseKametiRepository implements KametiRepository {
  FirebaseKametiRepository({FirebaseFirestore? firestore})
  ...
  @override
  Future<void> updateKameti(KametiModel kameti) =>
      _firestore.collection('kametis').doc(kameti.id).update({
        'name': kameti.name,
  ...
  @override
  Stream<DocumentSnapshot<Map<String, dynamic>>> streamKameti(
          String kametiId) =>
      _firestore.collection('kametis').doc(kametiId).snapshots();

  @override
  Stream<QuerySnapshot<Map<String, dynamic>>> streamUserKametis(
          String userId) =>
      _firestore
          .collection('users')
          .doc(userId)
  ...
  @override
  Future<void> startKameti(String kametiId) =>
      _firestore.collection('kametis').doc(kametiId).update({
        'status': KametiStatus.active.name,
        'startedAt': DateTime.now().millisecondsSinceEpoch
      });
}

class FirebaseMemberRepository implements MemberRepository {
  FirebaseMemberRepository({FirebaseFirestore? firestore})
      : _firestore = firestore ?? FirebaseFirestore.instance;
  final FirebaseFirestore _firestore;
  ...
  Future<void> acceptInvite(KametiInviteModel invite, String userId) async {
    final batch = _firestore.batch();
    batch.update(_firestore.collection('kametiInvites').doc(invite.id), {
      'status': KametiInviteStatus.accepted.name,
  ...
  @override
  Future<void> rejectInvite(String inviteId) => _firestore
      .collection('kametiInvites')
      .doc(inviteId)
      .update({'status': KametiInviteStatus.rejected.name});
...
class FirebasePaymentRepository implements PaymentRepository {
  ...
  Future<void> submitPaymentProof(String kametiId, String cycleId,
          String paymentId, Map<String, Object?> data) =>
      _payment(kametiId, cycleId, paymentId).update({
        ...data,
        'paymentStatus': PaymentStatus.pendingApproval.name,
  ...
  Future<void> approvePayment(String kametiId, String cycleId, String paymentId,
      ...
      _firestore.runTransaction((transaction) async {
        transaction.update(_payment(kametiId, cycleId, paymentId), {
          ...data,
  ...
  DocumentReference<Map<String, dynamic>> _payment(
          String kametiId, String cycleId, String paymentId) =>
      _firestore
          .collection('kametis')
          .doc(kametiId)
          .collection('cycles')
...
class FirebaseReceiverRepository implements ReceiverRepository {
  FirebaseReceiverRepository({FirebaseFirestore? firestore})
      : _firestore = firestore ?? FirebaseFirestore.instance;
  final FirebaseFirestore _firestore;
  ...
  Future<void> confirmReceiver(
      ...
      _firestore.runTransaction((transaction) async {
        final ref = _firestore
            .collection('kametis')
            .doc(kametiId)
            .collection('receiverAllocations')
            .doc(allocation.id);
        final existing = await transaction.get(ref);
        if (existing.exists) {
          throw StateError('Receiver already confirmed for this cycle.');
        }
        transaction.set(ref, {
          'id': allocation.id,
...
class FirebaseBiddingRepository implements BiddingRepository {
  FirebaseBiddingRepository({FirebaseFirestore? firestore})
      : _firestore = firestore ?? FirebaseFirestore.instance;
  final FirebaseFirestore _firestore;

  @override
  Future<void> startBidding(
          String kametiId, Map<String, Object?> sessionData) =>
      _session(kametiId, '${sessionData['id']}').set(sessionData);
  @override
  Future<void> submitBid(
          String kametiId, String sessionId, Map<String, Object?> bidData) =>
      _session(kametiId, sessionId)
          .collection('bids')
          .doc('${bidData['id']}')
          .set(bidData);
  @override
  ...
  @override
  Future<void> closeBidding(String kametiId, String sessionId) =>
      _session(kametiId, sessionId).update({
        'status': 'closed',
  ...
  Future<void> completeBidding(
          String kametiId, String sessionId, Map<String, Object?> resultData) =>
      _firestore.runTransaction((transaction) async =>
          transaction.update(_session(kametiId, sessionId), resultData));
  @override
  Stream<DocumentSnapshot<Map<String, dynamic>>> streamBiddingSession(
          String kametiId, String sessionId) =>
      _session(kametiId, sessionId).snapshots();
  @override
  Stream<QuerySnapshot<Map<String, dynamic>>> streamBids(
          String kametiId, String sessionId) =>
      _session(kametiId, sessionId).collection('bids').snapshots();
  DocumentReference<Map<String, dynamic>> _session(
          String kametiId, String sessionId) =>
      _firestore
          .collection('kametis')
          .doc(kametiId)
          .collection('biddingSessions')
          .doc(sessionId);
}

class FirebaseDrawRepository implements DrawRepository {
  FirebaseDrawRepository({FirebaseFirestore? firestore})
      : _firestore = firestore ?? FirebaseFirestore.instance;
  final FirebaseFirestore _firestore;
  @override
  Future<void> saveLuckyDrawResult(
...
class FirebaseLedgerRepository implements LedgerRepository {
  FirebaseLedgerRepository({FirebaseFirestore? firestore})
      : _firestore = firestore ?? FirebaseFirestore.instance;
  final FirebaseFirestore _firestore;
  @override
  Future<void> createLedgerEntry(String kametiId, LedgerEntryModel entry) =>
...
class FirebaseNotificationRepository implements NotificationRepository {
  ...
  final FirebaseFirestore _firestore;
  @override
  Future<void> createNotification(NotificationModel notification) => _firestore
          .collection('users')
        ...
        'kametiId': notification.kametiId,
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> streamUserNotifications(
      ...
      _firestore
          ...
          .snapshots();
  @override
  Future<void> markAsRead(String userId, String notificationId) => _firestore
          .collection('users')
          .doc(userId)
          .collection('notifications')
          .doc(notificationId)
...
class FirebaseAuditLogRepository implements AuditLogRepository {
  ...
  final FirebaseFirestore _firestore;
  @override
  Future<void> createAuditLog(AuditLogModel log) => _firestore
          .collection('kametis')
          .doc(log.kametiId)
        ...
        'actionType': log.actionType.name,
...
class FirebaseDisputeRepository implements DisputeRepository {
  FirebaseDisputeRepository({FirebaseFirestore? firestore})
      : _firestore = firestore ?? FirebaseFirestore.instance;
  final FirebaseFirestore _firestore;
  @override
  Future<void> createDispute(DisputeModel dispute) => _firestore
          .collection('kametis')
          .doc(dispute.kametiId)
          .collection('disputes')
          .doc(dispute.id)
          .set({
        'id': dispute.id,
        ...
        'type': dispute.disputeType.name,
        'status': dispute.status.name,
        'priority': dispute.priority.name,
        'title': dispute.title,
        'description': dispute.description,
        'createdAt': dispute.createdAt.millisecondsSinceEpoch
      });
  @override
  Future<void> updateDispute(
          String kametiId, String disputeId, Map<String, Object?> data) =>
      _firestore
          ...
          .update(data);
  @override
  Future<void> addDisputeComment(DisputeCommentModel comment) => _firestore
          .collection('kametis')
          .doc(comment.kametiId)
          .collection('disputes')
          .doc(comment.disputeId)
          .collection('comments')
          .doc(comment.id)
          .set({
        'id': comment.id,
  ...
  Future<void> resolveDispute(
          String kametiId, String disputeId, Map<String, Object?> resolution) =>
      updateDispute(kametiId, disputeId, resolution);
  @override
  Stream<QuerySnapshot<Map<String, dynamic>>> streamDisputes(String kametiId) =>
      _firestore
          .collection('kametis')
          ...
          .snapshots();
  @override
  Stream<QuerySnapshot<Map<String, dynamic>>> streamUserDisputes(
          String userId) =>
      _firestore
...
class FirebaseTrustScoreRepository implements TrustScoreRepository {
  FirebaseTrustScoreRepository({FirebaseFirestore? firestore})
      : _firestore = firestore ?? FirebaseFirestore.instance;
  final FirebaseFirestore _firestore;
  @override
  Future<void> updateTrustScore(TrustScoreModel score) => _firestore
          .collection('users')
          .doc(score.userId)
          .collection('trustScores')
          .doc(score.kametiId.isEmpty ? 'global' : score.kametiId)
          .set({
        'overallScore': score.overallScore,
        'riskLevel': score.riskLevel.name,
        'updatedAt': score.updatedAt.millisecondsSinceEpoch
      });
  @override
  Stream<DocumentSnapshot<Map<String, dynamic>>> streamTrustScore(
          String userId) =>
      _firestore
          ...
          .snapshots();
  @override
  Stream<QuerySnapshot<Map<String, dynamic>>> getRiskyMembers(
          String kametiId) =>
      _firestore
          .collection('kametis')
          .doc(kametiId)
          .collection('trustScores')
          .where('riskLevel', whereIn: ['risky', 'highRisk']).snapshots();
}

class FirebaseSecurityRepository implements SecurityRepository {
  FirebaseSecurityRepository({FirebaseFirestore? firestore})
      : _firestore = firestore ?? FirebaseFirestore.instance;
  final FirebaseFirestore _firestore;
  @override
  Future<void> reportUser(ReportUserModel report) => _firestore
          .collection('kametis')
          .doc(report.kametiId)
  ...
  @override
  Future<void> unblockMember(String kametiId, String memberId) => _firestore
      .collection('kametis')
      .doc(kametiId)
      .collection('members')
      .doc(memberId)
  ...
  @override
  Future<void> createDeletionRequest(DeletionRequestModel request) =>
      _firestore.collection('deletionRequests').doc(request.id).set({
        'id': request.id,
  ...
  Future<void> updatePrivacySettings(PrivacySettingsModel settings) =>
      _firestore
          ...
          .doc('privacy')
          .set({
        'hidePhoneFromMembers': settings.hidePhoneFromMembers,
        'hideCityFromMembers': settings.hideCityFromMembers,
        'hideCnicInReports': settings.hideCnicInReports,
        'allowGroupMembersViewFullLedger':
